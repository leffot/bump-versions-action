...
const utils_1 = __nccwpck_require__(694);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(811);
const file_command_1 = __nccwpck_require__(572);
const utils_1 = __nccwpck_require__(694);
const os = __importStar(__nccwpck_require__(2087));
const path = __importStar(__nccwpck_require__(5622));
const oidc_utils_1 = __nccwpck_require__(3764);
/**
...
const http_client_1 = __nccwpck_require__(2723);
const auth_1 = __nccwpck_require__(5849);
const core_1 = __nccwpck_require__(7329);
class OidcClient {
...
const pm = __nccwpck_require__(2854);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(4187);
            }
            const agentOptions = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__export(__nccwpck_require__(2862));
...
const debug_1 = __importDefault(__nccwpck_require__(7098));
...
module.exports = __nccwpck_require__(6830)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(7269);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(9424);
} else {
	module.exports = __nccwpck_require__(5421);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(1322);
...
const {GitExecutor} = __nccwpck_require__(86);
const {SimpleGitApi} = __nccwpck_require__(7835);

const {Scheduler} = __nccwpck_require__(4818);
const {GitLogger} = __nccwpck_require__(8315);
const {configurationErrorTask} = __nccwpck_require__(7871);
const {
   asArray,
   filterArray,
   filterPrimitives,
...
} = __nccwpck_require__(1757);
const {applyPatchTask} = __nccwpck_require__(3103)
const {branchTask, branchLocalTask, deleteBranchesTask, deleteBranchTask} = __nccwpck_require__(2886);
const {checkIgnoreTask} = __nccwpck_require__(8088);
const {checkIsRepoTask} = __nccwpck_require__(6781);
const {cloneTask, cloneMirrorTask} = __nccwpck_require__(9961);
const {cleanWithOptionsTask, isCleanOptionsArray} = __nccwpck_require__(9199);
const {commitTask} = __nccwpck_require__(2326);
const {diffSummaryTask} = __nccwpck_require__(8126);
const {fetchTask} = __nccwpck_require__(9178);
const {moveTask} = __nccwpck_require__(2121);
const {pullTask} = __nccwpck_require__(4409);
const {pushTagsTask} = __nccwpck_require__(3679);
const {addRemoteTask, getRemotesTask, listRemotesTask, remoteTask, removeRemoteTask} = __nccwpck_require__(7047);
const {getResetMode, resetTask} = __nccwpck_require__(817);
const {stashListTask} = __nccwpck_require__(2498);
const {addSubModuleTask, initSubModuleTask, subModuleTask, updateSubModuleTask} = __nccwpck_require__(2484);
const {addAnnotatedTagTask, addTagTask, tagListTask} = __nccwpck_require__(265);
const {straightThroughBufferTask, straightThroughStringTask} = __nccwpck_require__(7871);
...
const {gitP} = __nccwpck_require__(9309);
const {esModuleFactory, gitInstanceFactory, gitExportFactory} = __nccwpck_require__(6147);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const git_construct_error_1 = __nccwpck_require__(8421);
const git_error_1 = __nccwpck_require__(1968);
const git_plugin_error_1 = __nccwpck_require__(1726);
const git_response_error_1 = __nccwpck_require__(3453);
const task_configuration_error_1 = __nccwpck_require__(6910);
const check_is_repo_1 = __nccwpck_require__(6781);
const clean_1 = __nccwpck_require__(9199);
const config_1 = __nccwpck_require__(591);
const reset_1 = __nccwpck_require__(817);
const api = {
...
const api_1 = __nccwpck_require__(4559);
const plugins_1 = __nccwpck_require__(9060);
const utils_1 = __nccwpck_require__(1757);
const Git = __nccwpck_require__(9855);
/**
...
const debug_1 = __nccwpck_require__(7098);
const utils_1 = __nccwpck_require__(1757);
...
const BranchDeleteSummary_1 = __nccwpck_require__(3929);
const utils_1 = __nccwpck_require__(1757);
...
const BranchSummary_1 = __nccwpck_require__(6520);
const utils_1 = __nccwpck_require__(1757);
const parsers = [
...
const DiffSummary_1 = __nccwpck_require__(5229);
...
const utils_1 = __nccwpck_require__(1757);
const parse_diff_summary_1 = __nccwpck_require__(2278);
...
const MergeSummary_1 = __nccwpck_require__(7364);
const utils_1 = __nccwpck_require__(1757);
const parse_pull_1 = __nccwpck_require__(1844);
const parsers = [
...
const PullSummary_1 = __nccwpck_require__(1072);
const utils_1 = __nccwpck_require__(1757);
const parse_remote_messages_1 = __nccwpck_require__(3399);
...
const utils_1 = __nccwpck_require__(1757);
const parse_remote_objects_1 = __nccwpck_require__(6263);
const parsers = [
...
const promise_deferred_1 = __nccwpck_require__(3164);
const utils_1 = __nccwpck_require__(1757);
...
__exportStar(__nccwpck_require__(6884), exports);
__exportStar(__nccwpck_require__(5257), exports);
...
__exportStar(__nccwpck_require__(3228), exports);
__exportStar(__nccwpck_require__(4283), exports);
//# sourceMappingURL=index.js.map
...
const utils_1 = __nccwpck_require__(1757);
const FileStatusSummary_1 = __nccwpck_require__(1016);
/**
...
const git_error_1 = __nccwpck_require__(1968);
const task_1 = __nccwpck_require__(7871);
const utils_1 = __nccwpck_require__(1757);
const tasks_pending_queue_1 = __nccwpck_require__(8740);
...
const git_executor_chain_1 = __nccwpck_require__(6809);
class GitExecutor {
...
exports.gitP = void 0;
const git_response_error_1 = __nccwpck_require__(3453);
const git_factory_1 = __nccwpck_require__(6147);
...
const utils_1 = __nccwpck_require__(1757);
const promise_deferred_1 = __nccwpck_require__(3164);
const git_logger_1 = __nccwpck_require__(8315);
...
const task_callback_1 = __nccwpck_require__(5567);
const change_working_directory_1 = __nccwpck_require__(3562);
const config_1 = __nccwpck_require__(591);
const hash_object_1 = __nccwpck_require__(6383);
const init_1 = __nccwpck_require__(5218);
const log_1 = __nccwpck_require__(2797);
const merge_1 = __nccwpck_require__(4154);
const push_1 = __nccwpck_require__(3679);
const status_1 = __nccwpck_require__(3177);
const task_1 = __nccwpck_require__(7871);
const utils_1 = __nccwpck_require__(1757);
class SimpleGitApi {
...
const git_response_error_1 = __nccwpck_require__(3453);
const parse_branch_delete_1 = __nccwpck_require__(4460);
const parse_branch_1 = __nccwpck_require__(1146);
const utils_1 = __nccwpck_require__(1757);
...
const CheckIgnore_1 = __nccwpck_require__(380);
...
const CleanSummary_1 = __nccwpck_require__(8073);
const utils_1 = __nccwpck_require__(1757);
const task_1 = __nccwpck_require__(7871);
...
const parse_commit_1 = __nccwpck_require__(2637);
...
const ConfigList_1 = __nccwpck_require__(7616);
const utils_1 = __nccwpck_require__(1757);
var GitConfigScope;
...
const parse_fetch_1 = __nccwpck_require__(5904);
...
const InitSummary_1 = __nccwpck_require__(84);
...
const parse_list_log_summary_1 = __nccwpck_require__(9503);
const utils_1 = __nccwpck_require__(1757);
const task_1 = __nccwpck_require__(7871);
var excludeOptions;
...
const git_response_error_1 = __nccwpck_require__(3453);
const parse_merge_1 = __nccwpck_require__(1676);
const task_1 = __nccwpck_require__(7871);
...
const parse_move_1 = __nccwpck_require__(2028);
const utils_1 = __nccwpck_require__(1757);
...
const parse_push_1 = __nccwpck_require__(9994);
const utils_1 = __nccwpck_require__(1757);
...
const GetRemoteSummary_1 = __nccwpck_require__(237);
const task_1 = __nccwpck_require__(7871);
...
const StatusSummary_1 = __nccwpck_require__(682);
...
const TagList_1 = __nccwpck_require__(6048);
/**
...
const util_1 = __nccwpck_require__(8490);
...
__exportStar(__nccwpck_require__(1898), exports);
__exportStar(__nccwpck_require__(4019), exports);
__exportStar(__nccwpck_require__(4817), exports);
__exportStar(__nccwpck_require__(1745), exports);
__exportStar(__nccwpck_require__(5201), exports);
__exportStar(__nccwpck_require__(5223), exports);
__exportStar(__nccwpck_require__(8490), exports);
//# sourceMappingURL=index.js.map
...
const argument_filters_1 = __nccwpck_require__(9428);
const util_1 = __nccwpck_require__(8490);
...
const file_exists_1 = __nccwpck_require__(2573);
const NOOP = () => {
};
exports.NOOP = NOOP;
/**
...
module.exports = __nccwpck_require__(5571);
...
const core = __nccwpck_require__(7329)
const simpleGit = __nccwpck_require__(7212)
